...
-- todos
insert into todos (id, title, assignee_id, creator_id, description, link, project_id, context_id, priority, status, is_deleted, is_public, history, creation_date, due_date, completion_date ) values (1, 'Wash', 1, 2, 'fast', 'https://www.wash.hu', 1, 1, 1, 1, 0, 1, 'none', '2020-06-05 12:00:00', '2020-06-05 12:00:00', '2020-06-05 12:00:00');
insert into todos (id, title, assignee_id, creator_id, description, link, project_id, context_id, priority, status, is_deleted, is_public, history, creation_date, due_date, completion_date ) values (2, 'Clean', 2, 3, 'gentle', 'https://www.wash.hu', 2, 2, 2, 2, 0, 1, 'none', '2020-06-05 12:00:00', '2020-06-05 12:00:00', '2020-06-05 12:00:00');
